...
public class Persona implements Serializable {
    ...
    @Transient // Indica que 'email' no se persistirá en PostgreSQL
    private String email;
    @Transient // Indica que 'password' no se persistirá en PostgreSQL
    ...
    // Getters y setters para la lista de Tareas
