...
import utn.tpfinal.Services.PersonaService;
import utn.tpfinal.Services.TareaService;
...
public class TareaView extends VerticalLayout {
    ...
    private HorizontalLayout getToolbar() {
        ...
        backButton.addThemeVariants(ButtonVariant.LUMO_TERTIARY); // Un estilo más discreto
